...
#
# if running over single XS, use the "deRosa_perXS " function in deRosa_modelling.py
# if running over a set of XS, use the "deRosa_run" function in deRosa_modelling.py
#
# example:  
...
from riv_extract.d03_modelling.deRosa.spline_withR_NEW import runAlg as splineR
...
def mainFun( pointList, nVsteps=200, minVdep=0.1, allow_multichannel=False, create_plot=False ):
    ...
    if wetArea.type == 'MultiPolygon':
        ...
        for wetPolygon in wetArea:
            ...
            if wetPolygon.bounds[1] == minY:  #amended Russell-MDAP code
