...
# ## deRosa original code : tools / spline_withR.py
# 
# https://github.com/pierluigiderosa/BankFullDetection/blob/master/tools/spline_withR.py
# 
# ----

## Tweak 1
# change max iterations of newtonraphson from 100 to 20
# remove printing to reduce size of log
## 
## Tweak 2
# error trapping
